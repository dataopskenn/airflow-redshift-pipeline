...
"""
- This Infrastructre as  a Code can be modified to create different Redshift Instances.
- I didn't see the need to create a new copy for this project as this already works.

Copyright Credit: Copyright (c) 2020 Sanchit Kumar
"""